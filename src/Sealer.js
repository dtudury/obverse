import {v_to_t, OBJECT, ARRAY} from "./Types";

const BREAKS = Symbol("get map of broken seals"),
    MEND = Symbol("unbreak seals, get self"),
    DETACH = Symbol("stop informing dependent");
...
const seal = (object, t = v_to_t(object), dependent = () => {}) => {
        ...
        let broken_seals = null; //map of broken seals
